...
class TestBarkyModules(unittest.TestCase):
    ...
    def test_option_choice_is_valid(self):
        ...
        self.assertEqual(validChoice, True, "Should be true if the value is true")
    ...
    def test_get_user_input(self):
        ...
        value=get_user_input("enter the word test")
        self.assertEqual(value, "test", "Should be test")
    def test_get_new_bookmark_data(self):
        
        testValues=get_new_bookmark_data()
        self.assertIsNotNone(testValues)
